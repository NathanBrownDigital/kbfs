...
func NewBlockServerRemote(codec kbfscodec.Codec, signer kbfscrypto.Signer,
	...
	bs.putConn = newBlockServerRemoteClientHandler(
		"BlockServerRemotePut", log, signer, csg, blkSrvAddr, rpcLogFactory)
	bs.getConn = newBlockServerRemoteClientHandler(
		"BlockServerRemoteGet", log, signer, csg, blkSrvAddr, rpcLogFactory)
...
// For testing.
func newBlockServerRemoteWithClient(
